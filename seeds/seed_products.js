  ...
  await knex("products").insert([
    {
      ...
      price_cents: 2999,
      image_urls: JSON.stringify(["/assets/Rough-&-Tumble.png"]),
      category: "oils",
      in_stock_qty: 10,
    },
    {
      ...
      price_cents: 1599,
      image_urls: JSON.stringify(["/assets/moustwahe-wax-beard-balm.png"]),
      category: "waxes",
      in_stock_qty: 15,
    },
    {
      ...
      price_cents: 2499,
      image_urls: JSON.stringify(["/assets/sandalwood-wax.png"]),
      category: "balms",
      in_stock_qty: 20,
    },
    {
      ...
      price_cents: 1250,
      image_urls: JSON.stringify(["/assets/Beard-Balm.png"]),
      category: "tools",
      in_stock_qty: 50,
    },
    {
      ...
      price_cents: 1899,
      image_urls: JSON.stringify(["/assets/beard-wash.png"]),
      category: "washes",
      in_stock_qty: 12,
    },
    {
      ...
      price_cents: 3499,
      image_urls: JSON.stringify(["/assets/beardintgon-gold-beard-oil.png"]),
      category: "tools",
      in_stock_qty: 8,
    },
    {
      ...
      price_cents: 2750,
      image_urls: JSON.stringify(["/assets/tree-design-beard-oil.png"]),
      category: "oils",
      in_stock_qty: 25,
    },
    {
      ...
      price_cents: 2200,
      image_urls: JSON.stringify(["/assets/orange-beardington-tin.png"]),
      category: "balms",
      in_stock_qty: 14,
    },
    {
      ...
      price_cents: 4500,
      image_urls: JSON.stringify(["/assets/Beardington-beard-wax-black-tin.png"]),
      category: "tools",
      in_stock_qty: 5,
    },
    {
      ...
      price_cents: 2999,
      image_urls: JSON.stringify(["/assets/white-beardington-tin.png"]),
      category: "oils",
      in_stock_qty: 18,
    },
  ]);
